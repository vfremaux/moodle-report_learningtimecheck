...
require_once($CFG->dirroot.'/report/learningtimecheck/lib.php'); // to get xx_supports_feature();
if ('pro' == report_learningtimecheck_supports_feature()) {
    include($CFG->dirroot.'/report/learningtimecheck/pro/lang/fr/pro.php');
}
