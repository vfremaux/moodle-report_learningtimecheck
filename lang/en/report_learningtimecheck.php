...
$string['allowdisabledenrols'] = 'Allow disabled enrol instances';
$string['allowdisabledenrols_desc'] = 'If enabled, users with enrolments in disabled enrol instances will appear in reports.';
